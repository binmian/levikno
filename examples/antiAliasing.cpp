...
// INFO: this program uses framebuffers to acheive an anti-aliasing effect, this program will use a sample count of 8 for multisampling
...
int main(int argc, char** argv)
{
	...
	descriptorTextureUpdateInfo.textureInfo = fbImage;
