...
namespace lvn
{
    LVN_API LvnResult                   createGraphicsContext(LvnContext* ctx, LvnGraphicsContext** graphicsctx, LvnGraphicsContextCreateInfo* createInfo);
    LVN_API void                        destroyGraphicsContext(LvnGraphicsContext* graphicsctx);
